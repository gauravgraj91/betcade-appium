package com.betcade.appiumtests.core.managers;

import com.betcade.appiumtests.api.android.Android;
import com.betcade.appiumtests.core.Timer;
import com.betcade.appiumtests.core.constants.Arg;
import com.betcade.appiumtests.core.constants.Resources;
import com.betcade.appiumtests.core.ADB;
...
public class DriverManager {
    ...
    private static String nodeJS = "C:/Program Files (x86)/Appium/node.exe";
    private static String appiumJS = "C:/Program Files (x86)/Appium/node_modules/appium/bin/appium.js";
    ...
    private static URL host(String deviceID) throws MalformedURLException {
        if(hosts == null){
            ...
            hosts.put("04e7bbc02523da92", new URL("http://127.0.0.1:4723/wd/hub"));
